        ...
        >
          ...
          <div className="absolute inset-0 pointer-events-none" style={{ opacity: 0.04 }}>
            {Array.from({ length: 20 }).map((_, i) => (
              <div key={i} style={{ position: 'absolute', top: `${i * 5}%`, left: 0, right: 0, height: '1px', background: '#388BFD' }} />
            ))}
            {Array.from({ length: 20 }).map((_, i) => (
              <div key={i} style={{ position: 'absolute', left: `${i * 5}%`, top: 0, bottom: 0, width: '1px', background: '#388BFD' }} />
            ))}
          </div>
        ...
        <div className="w-full lg:w-[40%] flex items-center justify-center px-6 py-12">
          <div className="w-full max-w-sm">
            ...
            <p className="text-center mt-5 text-sm" style={{ color: '#8B949E' }}>
              ...
              <Link href="/signup" className="transition-all duration-200 cursor-pointer font-medium" style={{ color: '#388BFD' }}
