...
const TRACKED_FUTURES_SYMBOLS = [
  ...
  'MATICUSDT', 'NEARUSDT', 'UNIUSDT', 'ATOMUSDT', 'FTMUSDT',
  'OPUSDT', 'SUIUSDT', 'SEIUSDT', 'INJUSDT', 'TIAUSDT',
  // Tier 4 — memes with perps
  'PEPEUSDT', 'WIFUSDT', 'SHIBUSDT', 'WLDUSDT', 'RENDERUSDT', 'ORDIUSDT',
]
...
const SYMBOL_MAP: Record<string, string> = {
  ...
  ATOMUSDT: 'ATOM/USDT', FTMUSDT: 'FTM/USDT', OPUSDT: 'OP/USDT',
  SUIUSDT: 'SUI/USDT', SEIUSDT: 'SEI/USDT', INJUSDT: 'INJ/USDT',
  TIAUSDT: 'TIA/USDT',
  // Tier 4
  PEPEUSDT: 'PEPE/USDT', WIFUSDT: 'WIF/USDT', SHIBUSDT: 'SHIB/USDT',
  WLDUSDT: 'WLD/USDT', RENDERUSDT: 'RENDER/USDT', ORDIUSDT: 'ORDI/USDT',
}
